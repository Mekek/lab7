...
set CLASSPATH=%APP_HOME%\lib\client-2.2-plain.jar;%APP_HOME%\lib\log4j-core-2.20.0.jar;%APP_HOME%\lib\log4j-api-2.20.0.jar;%APP_HOME%\lib\shared-1.2-plain.jar;%APP_HOME%\lib\modelmapper-3.1.1.jar
